...
class GlobalStats {
  ...
  public:
    ...
    // req ack delay
    double getAverageReqAckDelay(const int src_id, const int dst_id);
    double getMaxReqAckDelay(const int src_id, const int dst_id);
    double getMaxReqAckDelay(const int node_id);

    double getAverageReqAckDelay();
    double getMaxReqAckDelay();

    // destroy delay
    double getAverageDestroyDelay(const int src_id, const int dst_id);
    double getMaxDestroyDelay(const int src_id, const int dst_id);
    double getMaxDestroyDelay(const int node_id);

    double getAverageDestroyDelay();
    double getMaxDestroyDelay();
