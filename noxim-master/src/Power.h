...
class Power {
  ...
  public:
    ...
    //this deals with power each time a flit needs O/E or E/O conversion
    void opticalInterface();
    //deals with the power due to MRs in onstate during each clock cycle
    void mrOnState(int numMRs);
  ...
  private:
    ...
    //new. Related to opticalMesh
    double opti_interface_pwr_d;
    double mr_onstate_pwr_s;
