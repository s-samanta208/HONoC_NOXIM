...
SC_MODULE(NoC)
{
    ...
    // NEW!!! Signals for Optical mesh
    sc_signal<Flit> **flit_opti;
    ...
    // Create Matrix of Optical Routers similar to tiles
    OptiRouter ***opti;
    ...
    //attempts to set the value denoting who reserved for corresponding router
    //If success returns true else returns false
    bool setOpticalReservation(int routerId, int dir, int value);
    //clears the reservation after completing transmission
    void clearOpticalReservation(int routerId, int dir);
